"""Automatic action scopes and fail-stop behavior in the native PydanticAI loop."""
...
class PydanticAiAutomaticRuntimeTests(fixtures.PydanticAiFixture, unittest.TestCase):
    ...
    def test_automatic_tool_is_absent_when_omitted_or_explicitly_disabled(self):
        for explicit in (False, True):
            with self.subTest(explicit=explicit):
                ...
                self.responses.extend([fixtures.completion(fixtures.tool_call(
    ...
    def test_three_native_approved_calls_use_real_receipts_and_frozen_scope(self):
        ...
        self.assertIn("LOCAL-PYDANTIC-AI-PROGRESS", self.receipts[0]["body"])
